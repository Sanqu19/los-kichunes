...
2. Estático con chunk sizePuedes especificar el tamaño exacto del bloque usando schedule(static, n). Aquí, OpenMP divide las iteraciones en bloques de tamaño $n$ y los reparte de forma circular (round-robin) entre los hilos.
